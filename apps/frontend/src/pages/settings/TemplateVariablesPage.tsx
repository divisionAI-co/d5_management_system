...
const TEMPLATE_VARIABLES: VariableGroup[] = [
  ...
  },
  {
    ...
    variables: [
      ...
      {
        name: '{{hrFeedback}}',
        description: 'HR feedback text',
        example: 'Excellent performance this month...',
        type: 'string',
      },
      {
        name: '{{hrActionDescription}}',
        description: 'Description of actions taken by HR',
      ...
      },
      {
        ...
        example: 'Outstanding collaboration with the client...',
        type: 'string',
      },
      {
      ...
      },
      {
        ...
        description: 'Communication rating with formatted badge HTML',
      ...
      },
      {
        ...
        description: 'Collaboration rating with formatted badge HTML',
      ...
      },
      {
        ...
        description: 'Task estimation rating with formatted badge HTML',
        example: '<span class="rating rating-4">4 - Exceeds expectations</span>',
        type: 'string',
      },
      {
      ...
      },
      {
        ...
        description: 'Timeliness rating with formatted badge HTML',
        example: '<span class="rating rating-5">5 - Outstanding</span>',
        type: 'string',
      },
      {
