...
const TEMPLATE_VARIABLES: VariableGroup[] = [
  {
    ...
    variables: [
      ...
      },
      {
        ...
        description: "Recruiter's full name (firstName + lastName)",
      ...
      {
        name: '{{recruiter.role}}',
        description: "Recruiter's role",
        example: 'RECRUITER',
        type: 'string',
      },
      {
        name: '{{recruiter.avatar}}',
        description: "Recruiter's avatar URL",
        example: 'https://example.com/avatar.jpg',
        type: 'string',
      },
      {
        name: '{{recruiter.bookingLink}}',
        description: "Recruiter's booking calendar link (if recruiter is also an employee)",
        example: 'https://calendly.com/jane-recruiter',
        type: 'string',
      },
    ],
  },
