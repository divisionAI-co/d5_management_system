    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="flex w-full max-w-3xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-6 px-6 py-6 lg:grid-cols-2">
          <section className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mb-2 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
              />
          ...
          <div className="flex flex-col gap-3 border-t border-gray-200 pt-4 lg:col-span-2 lg:flex-row lg:justify-end">
            <button
              type="button"
              onClick={onClose}
