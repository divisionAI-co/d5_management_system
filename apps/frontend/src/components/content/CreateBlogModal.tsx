          ...
          >
            ...
            <div>
              ...
              <RichTextEditor
                ...
                placeholder="Blog post content. You can insert images using Google Drive links."
                minHeight="300px"
              />
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-muted-foreground">
                Supports regular image URLs or Google Drive sharing links. Google Drive images will be automatically converted.
              </p>
            </div>
