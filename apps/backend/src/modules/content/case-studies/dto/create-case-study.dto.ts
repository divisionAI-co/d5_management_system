...
export class CreateCaseStudyDto {
  @ApiProperty({
    ...
    example: 'Digital Transformation for TechCorp',
  })
  @IsString()
  @MaxLength(200)
  title!: string;
  ...
  @ApiProperty({
    description: 'Full content of the case study (HTML or markdown)',
  })
  @IsString()
  content!: string;
  ...
  @ApiPropertyOptional({
    ...
    example: { revenueIncrease: '25%', timeSaved: '40 hours/week' },
  })
  @IsOptional()
  @IsObject()
